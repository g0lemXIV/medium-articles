...
class RekognitionLambdaS3TriggerStack(Stack):
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        bucket = s3.Bucket(self, 'Bucket', bucket_name="test-recognition-stack")
        ...
        lambda_function = _lambda.Function(
            ...
            code = _lambda.Code.from_asset('rekognition_lambda_s3_trigger/lambda_trigger'),
            environment = {
        ...
        statement.add_actions("rekognition:DetectProtectiveEquipment")
        ...
        # grant permissions for lambda_trigger to read/write to DynamoDB table and bucket
